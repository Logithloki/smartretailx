# AGENTS.md — SmartRetailX (COMP60010 Enterprise Cloud & Distributed Web Applications)
...
## Cost guardrails — standing orders for Codex
...
- NEVER write access keys, secrets, tokens, or JWT values into AGENTS.md,
